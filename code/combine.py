...
def combine(datasets_dict, dry_run=False):
    print(datasets_dict)
    apps = datasets_dict["/public/data0/NLP/users/wucanhui.volcano/datasets/all_self_gen_data/code_data/datasets--codeparrot--apps"]
    taco = datasets_dict["/public/data0/NLP/users/wucanhui.volcano/datasets/all_self_gen_data/code_data/datasets--BAAI--TACO"]
    codeforces = datasets_dict["/public/data0/NLP/users/wucanhui.volcano/datasets/all_self_gen_data/code_data/datasets--MatrixStudio--Codeforces-Python-Submissions"]
    ...
    if not dry_run:
        code_contests = datasets_dict["/public/data0/NLP/users/wucanhui.volcano/datasets/all_self_gen_data/code_data/datasets--deepmind--code_contests"]
